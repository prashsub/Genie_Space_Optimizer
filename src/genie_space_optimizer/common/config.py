...
TABLE_DESCRIPTION_ENRICHMENT_PROMPT = (
    ...
    '],\n'
    '"rationale": "Inferred purpose from table name and column names."}\n'
    '</example>\n'
    '</examples>\n'
    '\n'
    '<instructions>\n'
    ...
    '\n'
    'Rules:\n'
    '- Infer meaning from: table name, column names and types, and metric view context.\n'
    '- Be CONCISE — one sentence per section. Do NOT repeat information across sections.\n'
...
ADAPTIVE_STRATEGIST_PROMPT = (
    ...
    'Structured feedback from domain experts, grouped by type. Use these to '
    'inform lever choices — column descriptions map to Lever 1, business rules '
    'to Lever 2/5, join conditions to Lever 4, and instructions to Lever 5.\n'
