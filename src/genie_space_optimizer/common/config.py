...
BENCHMARK_GENERATION_PROMPT = (
    ...
    'Write the simplest correct SQL. Prefer fewer JOINs, columns, and filters.\n'
    '\n'
    '## Diversity\n'
...
DESCRIPTION_ENRICHMENT_PROMPT = (
    ...
    '    - order_amount (DOUBLE) [column_measure]\n'
    '    - customer_id (BIGINT) [column_key]\n'
    '    - fulfillment_status (STRING) [column_dim]\n'
    ...
    '],\n'
    '"rationale": "Inferred definitions from column names, data types, and table context."}\n'
    '</example>\n'
    '</examples>\n'
    '\n'
    '<instructions>\n'
    ...
    '\n'
    'Rules:\n'
    '- Infer meaning from: column name, data type, table purpose, and sibling columns.\n'
    '- Be CONCISE — one sentence per section.\n'
    '- For "values": only list values if confidently inferrable from the column name '
    '(e.g. status, type, category columns). Otherwise OMIT the values section.\n'
...
LEVER_5_HOLISTIC_PROMPT = (
    ...
    '    }\n'
    '  ],\n'
    '  "rationale": "Routing errors fixed via example SQL; temporal filter rule added to instructions."\n'
    '}\n'
    '</example>\n'
    '</examples>\n'
    '\n'
    ...
    'For ROUTING issues (wrong table/TVF/MV) or ambiguous patterns, propose example SQL. '
    'Genie pattern-matches against it directly.\n'
    '\n'
    ...
    '}\n'
    '\n'
    'If no example SQL needed, set "example_sql_proposals" to [].\n'
...
STRATEGIST_PROMPT = (
    ...
    '- global_instruction_rewrite MUST incorporate ALL existing instructions.\n'
    '\n'
    ...
    '        "5": {"instruction_guidance": "<text>", "example_sql": '
...
STRATEGIST_DETAIL_PROMPT = (
    ...
    '\n'
    '## Contract: Example SQL for Routing/Ambiguity\n'
    'Routing/ambiguity root causes MUST include example_sql in lever 5.\n'
    '\n'
    ...
    '  "instruction_contribution": "BUSINESS DEFINITIONS:\\n- product name = product_name from '
    'catalog.schema.dim_product (synonyms: product title, item name)\\n\\n'
    'JOIN GUIDANCE:\\n- For product name lookups, JOIN fact_sales to dim_product on product_key"\n'
    '}\n'
    '</example>\n'
    '</examples>\n'
    '\n'
    ...
    '  },\n'
    '  "coordination_notes": "<how levers reference each other>",\n'
    '  "instruction_contribution": "<plain-text fragment with ALL-CAPS SECTION HEADERS and colon, no Markdown>"\n'
    '}\n'
    '\n'
    'Rules:\n'
    '- Only include lever keys with work to do (from skeleton levers_needed).\n'
    '- "sections" keys from structured metadata schema.\n'
    '- instruction_contribution: {{ instruction_char_budget }} chars MAX.\n'
